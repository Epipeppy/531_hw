...
static struct argp_option options[] = {
  ...
  {"delete",    'd', 0,           0, "Item to delete from URL."},
  {"get",       'g', 0,           0, "Receive data from URL."},
  {"help",      'h', 0,           0, "Print help and exit."},
  {"post",      'o', 0,           0, "Item to place at URL; defaults to empty string."},
  {"put",       'p', 0,           0, "Item to place at URL."},
  {0, 0, 0, 0, 0}
};
